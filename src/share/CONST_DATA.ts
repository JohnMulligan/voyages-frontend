...
export const mappingSpecialistsRivers = `https://legacy.slavevoyages.org/static/maps/img/map_all/{z}/{x}/{y}.png`;
export const mappingSpecialistsCountries = `https://legacy.slavevoyages.org/static/maps/img/map_all/{z}/{x}/{y}.png`;
